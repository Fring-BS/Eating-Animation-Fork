...
> **Unofficial fork** of the beloved [Eating Animation](https://modrinth.com/mod/eating-animation) mod by `theone_ss`, ported to NeoForge for Minecraft **1.21.11** using the 1.21.4+ item model definition system. Original mod is MIT licensed; this fork is MIT licensed too. Full credit to the original author.
...
- **Built for 1.21.11** — compiled against the latest stable NeoForge for Minecraft **1.21.11** (a separate jar covers 1.21.4 – 1.21.10).

---

## Installation

1. Install [NeoForge](https://neoforged.net/) for your Minecraft version (1.21.11)
...
- `neoforge.mods.toml` declares `minecraft` version range `[1.21.11,1.21.12)` and `neoforge` range `[21.11,)` (latest stable build is 21.11.45).
...
A: Make sure you downloaded the jar that matches your loader (Fabric or NeoForge) and your Minecraft version. The 1.21.11 NeoForge jar requires Minecraft 1.21.11; for 1.21.4 – 1.21.10 use the separate `1.21.4-1.21.10` jar. The Fabric and NeoForge jars are NOT interchangeable — check the filename before installing.
