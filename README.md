...
A simple, client-side Fabric mod that adds smooth 3-stage sprite animations for eating food and drinking potions in Minecraft Watch your apple get smaller bite-by-bite, your bread tear apart, your potion bottle empty sip-by-sip — all in your hand, in the hotbar, and in the inventory.

> **Unofficial fork** of the beloved [Eating Animation](https://modrinth.com/mod/eating-animation) mod by `theone_ss`, ported to Minecraft newer versions using the new 1.21.4+ item model definition system. Original mod is MIT licensed; this fork is MIT licensed too. Full credit to the original author.
...
1. Install [Fabric Loader](https://fabricmc.net/use/) matching your downloaded mod's Minecraft version
