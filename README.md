...
> **Unofficial fork** of the beloved [Eating Animation](https://modrinth.com/mod/eating-animation) mod by `theone_ss`, ported to NeoForge for Minecraft **1.21.4 – 1.21.10** using the new 1.21.4+ item model definition system. Original mod is MIT licensed; this fork is MIT licensed too. Full credit to the original author.
...
- **One jar, wide version support** — a single NeoForge jar covers Minecraft **1.21.4 through 1.21.10**.

---

## Installation

1. Install [NeoForge](https://neoforged.net/) for your Minecraft version (1.21.4 – 1.21.10)
...
- `neoforge.mods.toml` declares `minecraft` version range `[1.21.4,1.21.11)`. The item model definition format used by the assets is identical across that whole range, so one jar serves every version.

---

## Building from source

Requirements: JDK 21 and an internet connection.
...
A: Make sure you downloaded the jar that matches your loader (Fabric or NeoForge) and that your Minecraft version is between 1.21.4 and 1.21.10. The Fabric and NeoForge jars are NOT interchangeable — check the filename before installing.
